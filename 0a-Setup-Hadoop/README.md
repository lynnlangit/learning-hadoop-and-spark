...
- SaaS - use **Serverless** endpoints, i.e. Serverless Sessions for GCP, [Job Runs](https://docs.aws.amazon.com/emr/latest/EMR-Serverless-UserGuide/emr-serverless.html) for AWS...
